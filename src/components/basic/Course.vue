  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-menu"></i> 课程信息管理</el-breadcrumb-item>
    ...
    <el-table
      ...
      @row-click="rowClick"
      style="width: 100%">
      <el-table-column prop="course_id" label="课程ID" width="250">
      </el-table-column>
      ...
      <el-table-column prop="course_type_id" label="课程类别" width="250">
      </el-table-column>
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        <div style="margin-top: 10px">
          <span>课程ID</span>
          <el-input size="mini" style="width: 200px;" v-model="course_id" placeholder="请输入..." ></el-input>
        </div>
        <div style="margin-top: 10px">
          <span>课程名称</span>
          <el-input size="mini" style="width: 200px;" v-model="course_name" placeholder="请输入..." ></el-input>
        </div>
        <div style="margin-top: 10px">
          <span>英文名称</span>
          <el-input size="mini" style="width: 200px;" v-model="english_name" placeholder="请输入..." ></el-input>
        </div>
        <div style="margin-top: 10px">
          <span>课程代码</span>
          <el-input size="mini" style="width: 200px;" v-model="course_code" placeholder="请输入......" ></el-input>
        </div>
        <div style="margin-top: 10px">
          <span>课程类别</span>
