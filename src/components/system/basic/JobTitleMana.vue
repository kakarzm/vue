  ...
  <div>
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        width="25%">
        <el-input v-model="updatePosName" size="mini" placeholder="请输入新的职称名称..."></el-input>
...
export default{
  ...
  methods: {
    updatePosNameExec () {
      ...
      this.loading = true
      var _this = this
      this.putRequest('/system/basic/joblevel', {name: this.updatePosName, id: this.updatePosId, titleLevel: this.updateTitleLevel}).then(resp => {
        _this.loading = false
